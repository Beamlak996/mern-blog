    ...
    <Footer container className="border border-t-8 border-teal-500">
      <div className="w-full max-w-7xl mx-auto">
        <div className="grid w-full justify-between sm:flex md:grid-cols-1">
          ...
          <div className="grid grid-cols-2 gap-8 mt-4 sm:grid-cols-3 sm:gap-6">
            <div>
              ...
              <Footer.LinkGroup>
                <Footer.Link href="#" target="_blank" >100 JS Projects</Footer.Link>
                <Footer.Link href="/about" target="_blank" >Beamlak's Blog</Footer.Link>
              </Footer.LinkGroup>
            </div>
            <div>
              ...
              <Footer.LinkGroup>
                ...
                <Footer.Link href="/about" target="_blank" >Discord</Footer.Link>
              </Footer.LinkGroup>
            </div>
            <div>
        ...
        <div className="w-full sm:flex sm:items-center sm:justify-between" >
            <Footer.Copyright href="#" by="Beamlak's Blog" year={new Date().getFullYear()} />
